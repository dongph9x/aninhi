...
async function checkUsersWithGen2Fish() {
  console.log('🔍 Kiểm Tra User Có Cá Gen 2\n');
  ...
  try {
    ...
    // 2. Thống kê theo generation
    console.log('\n2️⃣ Thống Kê Theo Generation:');
    ...
    // 3. Tìm user có cá gen 2
    console.log('\n3️⃣ Tìm User Có Cá Gen 2:');
    ...
    // 4. Tìm user có cá gen 3+
    console.log('\n4️⃣ Tìm User Có Cá Gen 3+:');
    ...
    // 5. Thống kê chi tiết theo rarity
    console.log('\n5️⃣ Thống Kê Chi Tiết Theo Rarity:');
    ...
    // 6. Top 10 user có nhiều cá nhất
    console.log('\n6️⃣ Top 10 User Có Nhiều Cá Nhất:');
    ...
    console.error('❌ Lỗi khi kiểm tra user có cá gen 2:', error);
  } finally {
